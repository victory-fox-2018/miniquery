 ...
 */
 ...
 //   return {
 //     el: SweetSelector.select(param),
 //     hide: DOM.hide(param),
 //     show: DOM.show(param),
 //     addClass: DOM.addClass(param),
 //     removeClass: DOM.removeClass(param),
 //     on: EventDispatcher.on(param, event, cb),
 //     trigger: EventDispatcher.trigger(param, event)
 //   }
 // }
